...
class UpdateTravelController extends ChangeNotifier {
  ...
  /// Updates an existing travel with the given data.
  ///
  ...
  Future<bool> updateTravel(
    ...
    try {
      ...
      final response = await CompassService.instance
          .updateTravel(token, travelId, travelData);
      ...
      if (response['status'] == 'success') {
        ...
        _setError(
            response['message'] as String? ?? 'Failed to update travel.');
        return false;
      }
    } catch (e) {
