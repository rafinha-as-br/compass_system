 ...
 * 
 * Define:
 * - Quais rotas são públicas (login, cadastro, teste)
 * - Quais rotas exigem autenticação (todas as outras do /api/**)
 * - CORS global liberado para o front-end
 * - Sessão stateless (sem cookies de sessão, apenas JWT)
 */
@Configuration
@EnableWebSecurity
